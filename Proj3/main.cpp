...
int main(int argc, char *argv[])
{
    ...
    int System = 1; //  0 = Solar system, 1 = Earth/Sun/Jupiter, 2 = Mercury Precession, 3 = Earth/Sun
//    switch (argc) {
...
//    }
    ...
    if ( System == 1){
        ...
        CelestialBody Jupiter_z0 = CelestialBody(1.898E27*10/solarMass,-2.724865762194714E+00,-4.624789318060123E+00,0,6.411862928919486E-03*365.25,-3.471082490961821E-03*365.25,-1.290147901227175E-04*365.25);
        m_Objects.push_back(Sun);
    ...
    if ( System == 2 ){
        ...
        Solver Solv = Solver( 1e8,100,m_Objects, 2 );
        Solv.solve();
    }
